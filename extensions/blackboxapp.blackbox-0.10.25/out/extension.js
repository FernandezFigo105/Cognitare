		...
		<body>
			...
			<script>
				(function() {
					...
					function showCode(data){
						const {codes, query, lineNumbers, timings, languages} = data
						$(".result-holder").remove()
						codes.forEach((codeVal, idx)=>{
							...
							const $btns = $('<div class="top-container"><div class="text-container"><div class="top-date">'+idxDate+'</div><div class="top-language">'+language+'</div></div><div class="btn-container"><div class="btn-delete btn-option">Delete</div><div class="btn-edit btn-option">Edit</div></div></div>')
							$holder.prepend($btns)
		...
		`
			...
			<body>
				...
				<l class='text-description'>
					...
					<div>
					<div>
						<img class="codecomplete-tutorial" style="cursor: pointer" src="https://storage.googleapis.com/aa32ad/3861158cd9.gif">
					</div>
					...
					2. Repo Search<br><br>
					<div>
						<img style="cursor: pointer" class="btn-search" src="https://storage.googleapis.com/aa32ad/democodesearch.gif">
					</div>
					<div class="btn-default btn-code-search-holder">
						<span class="btn-code-search">Blackbox Code Search</span>
					</div>
					3. Turn Question to Code<br><br>
					<div>
					...
					<div class="btn-default btn-search">
						<span class="btn-search">Blackbox Tutorial</span>
					</div>
					<div class="btn-default btn-history-search-holder">
						<span class="btn-history-search">Saved Snippets</span>
					</div>
				</l>
				<br><br>
